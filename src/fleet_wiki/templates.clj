...
(defn edit-page
	([topic]
	(edit-template (form-to [:post (str "/wiki/" topic)]
					(text-area "content")
					(submit-button "Contribute knowledge"))))
	([topic content] (edit-template (form-to [:post (str "/wiki/" topic)] (text-area "content" content) (submit-button "Contribute knowledge")))))
